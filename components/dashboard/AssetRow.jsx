...
const AssetRow = ({asset, usdValue, type, supplied, borrowed, rewards, Logo, apy}) => (
    <tr className="hover:bg-purple-50 transition-colors">
        ...
        <td className="p-3 border-b">
            <div className="flex flex-col gap-2">
                <button className="px-3 py-1 text-sm font-semibold rounded-lg border border-purple-200 hover:bg-purple-50 transition-colors">
                    Supply More
                </button>
                <button className="px-3 py-1 text-sm font-semibold rounded-lg border border-purple-200 hover:bg-purple-50 transition-colors">
                    Withdraw
