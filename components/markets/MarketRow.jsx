...
const MarketRow = ({market, onViewDetails}) => (
    <tr className="border-b border-purple-100 hover:bg-purple-50 transition-colors">
        <td className="p-3 cursor-pointer">
            ...
            <div className="text-sm text-purple-600">${Number(market.price).toFixed(2)}</div>
        </td>
        ...
        <td className="p-3 cursor-pointer">
            <div>{market.totalBorrows}</div>
            <div className="text-sm text-purple-600">{market.totalBorrows} {market.asset}</div>
        </td>
        <td className="p-3">
            <button
